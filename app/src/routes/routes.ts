...
routerApp.post('/login', authMiddleware.validateUserCredentials, globalCheck.checkRole,  loginController.login);
...
routerApp.post('/api/transits', authMiddleware.authenticateJWT,authMiddleware.isPassageOrOperator, validateData.validateTransitDataCreation, globalCheck.checkParkingCapacity, (req: any, res: any) => CRUDController.createRecord(Transit, req, res));
